...
- Stage26 下一步只剩外部人工签核：真人首次通关与至少一次能力回访、悬赏回交 / Build 调整理解度、实体手柄型号 / 漂移 / 死区 / 按键舒适度；未取得这些证据前保持 Alpha Candidate。
