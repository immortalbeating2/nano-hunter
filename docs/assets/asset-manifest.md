...
| stage12_shrine_trial_biome_reference | 第一区域镇妖试炼场环境参考 | `assets/art/environment/biome_01_shrine_trial/.gitkeep` | 目录占位 | 待补 | 待确认 | needed | Stage 13+ | P2 | Stage 12 只建立目录，不提前生产完整环境资产 |
...
| stage16_minimal_bgm | Stage16 minimal BGM loop | `assets/audio/music/stage16_minimal_bgm.ogg` | Seamless short loop, final format TBD | To source | License pending | needed | Stage 16 | P2 | Records BGM need for Alpha Demo release notes |
