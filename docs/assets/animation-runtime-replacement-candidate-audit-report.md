...
| `luna_jump_fall_runtime_sheet_ai01` | `runtime_replacement_ready` | - | left=24, top=40, right=24, bottom=8 | 1 | - |
...
| `luna_attack_01_runtime_sheet_ai01` | `archived_blocked_reference` | luna_attack_body_runtime_sheet_ai02, stage12_slash_vfx | - |
