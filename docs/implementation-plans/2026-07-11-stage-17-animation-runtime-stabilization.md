...
- [ ] **Step 3：实现统一 normalized progress 到关键帧映射**
...
- [ ] **Step 4：Attack 由 gameplay phase 驱动 body 与 VFX**
...
- [ ] **Step 5：Air Dash 和 Hit React 改为手动帧映射**
...
- [ ] **Step 1：按 Model Lock v1 生成单一 jump-state sheet**
...
- [ ] **Step 2：SpriteFrames 使用固定 animation 名**
...
- [ ] **Step 2：Basic / Aerial / Caster 只映射真实行为**
...
- [ ] **Step 3：Ground Charger 在真实状态切换时改动画**
...
- [ ] **Step 2：strike 和 recovery 分别映射 attack 前后帧**
...
- [ ] **Step 3：staggered 使用独立资源和 `stagger_duration`**
...
- [ ] **Step 1：复用现有场景而不是制作新 showcase 场景**
