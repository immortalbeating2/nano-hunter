...
const TARGET_BODY_ASSET_ID := "luna_air_dash_body_runtime_sheet_ai02"
const TARGET_BODY_SPRITEFRAMES := "res://assets/art/characters/player/sprite_sheets/runtime_replacement/luna_air_dash_body_runtime_sheet_ai02.spriteframes.tres"
