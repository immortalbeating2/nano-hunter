...
> 原始执行用计划仍保留在 [2026-04-23-stage-6-minimal-real-combat-loop.md](/Users/peng8/Desktop/Project/Game/nano-hunter/docs/implementation-plans/2026-04-23-stage-6-minimal-real-combat-loop.md)。
...
- 开始实现前补齐 `spec-design/` 设计文档、`docs/implementation-plans/` 实现计划、`docs/progress/` 启动记录。
