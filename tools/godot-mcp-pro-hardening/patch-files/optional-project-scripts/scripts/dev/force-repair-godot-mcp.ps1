...
# 这会影响同机其他 IDE/CLI / Godot MCP 会话，只应在当前会话已不可用且人工确认安全时使用。
# 日常优先使用 enter-worktree-godot-mcp.ps1 或 safe-repair-godot-mcp.ps1；本脚本只作为最后兜底。
...
Write-GodotMcpSection -Title "Remaining Bridge Listeners (stdio 17605-17619; legacy 6505-6509)" -Rows @(Get-GodotMcpBridgeListeners | Sort-Object LocalPort)
