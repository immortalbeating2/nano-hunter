...
# 安全边界：
# - 只有 17605-17619 或 legacy 6505-6509 stdio listener 才算 MCP bridge 证据。
# - 17620-17624 / legacy 6510-6514 是 godot-cli reserved，不代表当前 MCP bridge 已可用。
...
if (-not $bridgeListeners) {
    throw "No stdio godot-mcp bridge listeners were detected on 17605-17619 or legacy 6505-6509. Reopen the current IDE/CLI session first."
}
...
Write-GodotMcpSection -Title "Bridge Listeners (stdio 17605-17619; legacy 6505-6509)" -Rows @(Get-GodotMcpBridgeListeners | Sort-Object LocalPort)
Write-GodotMcpSection -Title "CLI Listeners (cli 17620-17624; legacy 6510-6514)" -Rows @(Get-GodotMcpCliListeners | Sort-Object LocalPort)
