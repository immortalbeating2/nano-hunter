...
Groups:`);
  ...
  console.log(`
Options:
  --port <N>   Godot WebSocket port (default: auto-detect 17620-17624)
...
// The Godot plugin is a WebSocket CLIENT that connects to stdio and CLI ranges separately.
// CLI uses 17620-17624 so short-lived commands do not compete with stdio bridge sessions.
